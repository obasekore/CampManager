		  		...
		  		<div class="col-md-6">
		  			<div class="content-box-large">
		  				...
		  				<div class="panel-body">
                                <div class="row">
                                	<div class="col-md-12">
	                                    <div class="btn btn-block btn-primary" id="setEstablishmentName" >Change Establishment Name</div>
                                    </div>
                                </div>
                                <br>
                                ...
                                <div class="row">
	                                <div class="col-md-12">
    	                            	<div class="btn btn-block btn-info" id="setCampDefault">Set Default Camp</div>
                                    </div>
                                </div><br>
                                
                                <div class="row">
                                	<div class="col-md-12">
	                                	<div class="btn btn-block btn-success" id="addAdmin">Add Admin</div>
                                    </div>
                                </div><br>

                                <div class="row">
                                	<div class="col-md-12">
	                                	<div class="btn btn-block btn-success">Other Settings</div>
                                    </div>
                                </div>
...
<script>
$('#setCampDefault').click(function(){
		$('#loader').show('slow');
		$.ajax({
			type: 'POST',
			url: 'route.php',
			data:{purp:'setDefaultCamp'},
...
$('#setEstablishmentName').click(function(){
	
		$('#loader').show('slow');
		$.ajax({
			type: 'POST',
			url: 'route.php',
			data:{purp:'setEstablishName'},
			success: function (msg) {
				$('#publicDump').html('');
				$('#publicDump').html(msg);
				$('#loader').hide('slow');
