if (wysihtml5.browser.supported()) {
  ...
  asyncTest("check that he default parser rules work as expected", function() {
    ...
    editor.observe("load", function() {
      ...
      equal(editor.parse('standard internet image: <img width="foo" height="50px" src="../../../../Bootstrap-Admin-Theme-3-master/vendors/bootstrap-wysihtml5/test/bootstrap_wysihtml5/cdn0.sbnation.com/imported_assets/155249/kitties.jpg">').toLowerCase(),
